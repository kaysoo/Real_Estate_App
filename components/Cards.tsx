  ...
  return (
    ...
    >
      ...
      <View className="flex flex-col items-start absolute bottom-5 inset-x-5">
        <Text
          className="text-xl font font-rubik-extrabold text-white"
          numberOfLines={1}
        >
          {name}
        </Text>
...
export const Card = ({
  ...
  return (
    ...
    >
      <View className="flex flex-row items-center bg-white/90 px-2 p-1 rounded-full z-50 absolute top-5 right-5">
